...
3. SSH auth: `git clone git@github.com:Unity-Billal-mesloub/vscode-docs.git`<br>HTTPS auth: `git clone https://github.com/Unity-Billal-mesloub/vscode-docs.git`
...
3. Clone the repo without binary files.
    - macOS / Linux:
      - SSH auth: `GIT_LFS_SKIP_SMUDGE=1 git clone git@github.com:Unity-Billal-mesloub/vscode-docs.git`
      - HTTPS auth: `GIT_LFS_SKIP_SMUDGE=1 git clone https://github.com/Unity-Billal-mesloub/vscode-docs.git`
    - Windows:
      - SSH auth: `$env:GIT_LFS_SKIP_SMUDGE="1"; git clone git@github.com:Unity-Billal-mesloub/vscode-docs.git`
      - HTTPS auth: `$env:GIT_LFS_SKIP_SMUDGE="1"; git clone https://github.com/Unity-Billal-mesloub/vscode-docs.git`
